...
def test_create_blocker_is_open_versioned_blocks_task_and_notifies_creator() -> None:
    ...
    assert notification.recipient_employee_no == "CREATOR"
...
def test_node_collaborator_cannot_create_task_issue() -> None:
    node = TaskNode(
        node_id=uuid4(),
        task_id=uuid4(),
        node_order=1,
