...
class OpenAICompatibleTaskAgentProvider:
    ...
    def __init__(
        ...
        *,
        ...
        intake_prompt_path: Path = DEFAULT_INTAKE_PROMPT_PATH,
        decomposition_prompt_path: Path = DEFAULT_DECOMPOSITION_PROMPT_PATH,
        ...
        self._model = model
        # Explicit prompt_path preserves the historical test/custom-provider contract.
        self._intake_prompt_path = prompt_path or intake_prompt_path
        self._decomposition_prompt_path = prompt_path or decomposition_prompt_path
    ...
    def extract(
        ...
        raw_result = self._complete(agent_context, prompt_path=self._intake_prompt_path)
    ...
    def decompose(self, extracted: Mapping[str, object]) -> dict[str, object]:
        ...
        raw_result = self._complete(agent_context, prompt_path=self._decomposition_prompt_path)
