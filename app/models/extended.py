...
class TaskArchive(Base):
    ...
    # Feature 11 keeps legacy snapshots readable but new automatic archives do
    # not materialize a snapshot.  The nullable column is a compatibility seam.
    archive_snapshot: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
