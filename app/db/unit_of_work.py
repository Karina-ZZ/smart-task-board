...
class UnitOfWork:
    ...
    def __enter__(self) -> UnitOfWork:
        ...
        self.task_archives = TaskArchiveRepository(self.session)
        self.task_change_requests = TaskChangeRequestRepository(self.session)
        self.task_decompositions = TaskDecompositionRepository(self.session)
