...
| 质量门 | 实测结果 | 说明 |
|---|---|---|
| 后端全量 pytest（非 PostgreSQL） | ✅ `495 passed, 28 deselected` | 28 项 deselected 均为 PostgreSQL opt-in 集成测试 |
